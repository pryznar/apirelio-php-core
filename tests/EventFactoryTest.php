...
use Tracium\Core\Data\TraciumApplication;
use Tracium\Core\Data\TraciumCustomer;
...
final class EventFactoryTest extends TestCase
{
    public function test_it_builds_the_shared_bounded_event_contract(): void
    {
        $event = (new EventFactory())->create(new EventContext(
            ...
            responseBytes: 120,
            customer: new TraciumCustomer('customer_42', 'Acme', 'growth'),
            application: new TraciumApplication('erp', 'ERP'),
            apiVersion: 'v2',
            sdk: 'symfony',
            sdkVersion: '0.1.0',
